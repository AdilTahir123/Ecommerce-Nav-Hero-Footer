    ...
    <div className='my-10'>
      <div className='text-center text-3xl py-8'>
        ...
        <p className='w-3/4 m-auto text-xs sm:text-sm md:text-base text-gray-600'>
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Illo voluptatum assumenda vitae dicta impedit accusantium natus in, odit molestiae. Optio sequi adipisci vel.
        </p>
      </div>
